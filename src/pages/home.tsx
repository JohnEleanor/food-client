  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <div className="grid gap-8 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
          <Card className="max-w-full px-10 py-10 lg:px-1 py-1" x-chunk="charts-02-chunk-5">
          ...
          <Card className="max-w-full col-span-2 w-full" x-chunk="charts-02-chunk-5">
